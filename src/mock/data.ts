...
export const MOCK_LANDMARKS: Landmark[] = [
  ...
  // Beyond the two-town pilot area — added for the province's larger cities
  // so a landmark search isn't empty the moment a TODA outside San Jose/
  // Muñoz signs up, ahead of any admin having seeded their own yet.
  {
    id: 'landmark-9',
    name: 'Cabanatuan City Public Market',
    aliases: ['palengke', 'pamilihan', 'cabanatuan market', 'public market'],
    category: 'market',
    city: 'Cabanatuan City',
    gps: { lat: 15.4867, lng: 120.9679 },
    todaOrgId: null,
  },
  {
    id: 'landmark-10',
    name: 'Cabanatuan City Hall',
    aliases: ['city hall', 'munisipyo', 'bayan'],
    category: 'government',
    city: 'Cabanatuan City',
    gps: { lat: 15.4886, lng: 120.9689 },
    todaOrgId: null,
  },
  {
    id: 'landmark-11',
    name: 'Freedom Park, Cabanatuan City',
    aliases: ['freedom park', 'plaza', 'liwasan'],
    category: 'other',
    city: 'Cabanatuan City',
    gps: { lat: 15.4855, lng: 120.9668 },
    todaOrgId: null,
  },
  {
    id: 'landmark-12',
    name: 'Gapan Cathedral',
    aliases: ['simbahan', 'church', 'gapan cathedral', 'parokya'],
    category: 'church',
    city: 'Gapan City',
    gps: { lat: 15.3053, lng: 120.9473 },
    todaOrgId: null,
  },
  {
    id: 'landmark-13',
    name: 'Gapan Public Market',
    aliases: ['palengke', 'pamilihan', 'gapan market', 'public market'],
    category: 'market',
    city: 'Gapan City',
    gps: { lat: 15.307, lng: 120.9489 },
    todaOrgId: null,
  },
  {
    id: 'landmark-14',
    name: 'Nueva Ecija Provincial Capitol',
    aliases: ['capitol', 'kapitolyo', 'provincial capitol'],
    category: 'government',
    city: 'Palayan City',
    gps: { lat: 15.5378, lng: 121.081 },
    todaOrgId: null,
  },
  {
    id: 'landmark-15',
    name: 'Palayan City Public Market',
    aliases: ['palengke', 'pamilihan', 'palayan market', 'public market'],
    category: 'market',
    city: 'Palayan City',
