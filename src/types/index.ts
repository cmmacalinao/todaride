...
export interface Pharmacy {
  ...
  tagline?: string | null
  // The banner as one picture (960×504 JPEG), drawn on the vendor's own
...
// How many posts a store keeps on its feed: one — a photo and a message,
// which posting again replaces (see VendorFeedComposer and
// ADD_VENDOR_POST). The replaced post is tombstoned so no device brings
// it back.
export const MAX_VENDOR_POSTS = 1
